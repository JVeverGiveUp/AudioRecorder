...
Java_com_ptdstudio_internalsoundrecorder_PCMToMp3Encoder_init(JNIEnv *env, jclass type, jstring pcmFilePath_,
...
Java_com_ptdstudio_internalsoundrecorder_PCMToMp3Encoder_encode(JNIEnv *env, jclass type) {

    encoder->Encode();

}extern "C"
JNIEXPORT void JNICALL
Java_com_ptdstudio_internalsoundrecorder_PCMToMp3Encoder_destroy(JNIEnv *env, jclass type) {
