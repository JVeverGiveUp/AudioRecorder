...
public class InternalMp3RecorderNew implements RecorderContract.Recorder {
	...
	private static class InternalMp3RecorderSingletonHolder {
		private static final InternalMp3RecorderNew singleton = new InternalMp3RecorderNew();

		public static InternalMp3RecorderNew getSingleton() {
			return InternalMp3RecorderSingletonHolder.singleton;
		}
	}

	public static InternalMp3RecorderNew getInstance() {
		return InternalMp3RecorderSingletonHolder.getSingleton();
	}

	private InternalMp3RecorderNew() { }
	...
	public void startRecording(String outputFile, int channelCount, int sampleRate, int bitrate) {
		...
		if (recordFile.exists() && recordFile.isFile()) {
			try {
				...
				Log.d("Mp3Recorder", "Modified: " + sampleRate + " - " + channel + " - " + bitrate + " - " + bufferSize);
